        ...
        <div className="animate-slide-up mb-16 grid grid-cols-1 items-end gap-8 lg:mb-24 lg:grid-cols-3 lg:gap-12">
          <div className="col-span-1 lg:col-span-2">
            ...
            <h2 className="break-words text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
              DIGITAL SYSTEMS FOR
              <span className="block text-gradient-teal-gold mt-2">
                GROWING BUSINESSES
              </span>
            </h2>
          </div>
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className="absolute -right-20 -top-20 h-40 w-40 rounded-full opacity-0 blur-[80px] transition-opacity duration-500 group-hover:opacity-20 pointer-events-none"
                ...
                <div className="mt-10 flex items-center justify-between border-t border-white/5 pt-6">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-brand-teal group-hover:text-white transition-colors duration-300">
                    Explore Platform
                  </span>
                  <div
